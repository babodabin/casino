...
const styles = StyleSheet.create({
  ...
  cardWinner: { transform: [{ translateY: -10 }], borderWidth: 3, borderColor: '#F2C85B', shadowColor: '#FFD35F', shadowOpacity: 0.9, shadowRadius: 10, elevation: 9 },
  cardSelected: { transform: [{ translateY: -5 }], borderWidth: 2, borderColor: '#D6DCE6' },
  cardDim: { opacity: 0.42, transform: [{ scale: 0.96 }] },
