...
export const pachiAtContinue = 0.556;
...
// ── 200만 게임을 돌려 잰 값 (2026-08-30) ────────────────────────────────
//
//   환급률        95.03%
//   당첨 간격     평균 227게임 (통상 73.4% · 찬스존 25.8% · 천장 0.8%)
//   AT 한 번      평균 113.1게임 · 272매 획득
//   AT 순증       2.42매/G          (붙여 주신 글의 순증 2.5와 같은 자리)
